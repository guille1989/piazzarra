...
class inventarioPopayanReview extends Component {
    constructor(props) {
        super(props);
        this.state={
            fecha_aux_01: '',
    ...
    componentDidMount(){
        ...
        const requestOptions ={
          ...
          fetch(`http://${process.env.REACT_APP_URL_PRODUCCION}/api/leerinventarios/` + today + `/Pizzarra-Popayan-Centro`, requestOptions)
    ...
    handleFechaHoy(e){
        ...
        const requestOptions ={
          ...
          fetch(`http://${process.env.REACT_APP_URL_PRODUCCION}/api/leerinventarios/` + e.target.value + `/Pizzarra-Popayan-Centro`, requestOptions)
              .then(response => response.json())
              .then(data => {
                //console.log(data.inv)
                if(data.inv === undefined){
...
export default inventarioPopayanReview;