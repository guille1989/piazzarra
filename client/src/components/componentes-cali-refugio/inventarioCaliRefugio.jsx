...
class inventarioCaliRefugio extends Component {
    ...
    componentDidMount(){
        ...
        fetch('http://54.236.28.178/api/insumos', requestOptions)
        ...
        fetch('http://54.236.28.178/api/revisioninventariofecha/' + today, requestOptions)
        .then(response => response.json())
        .then(data => {
    ...
    handleFechaHoy(e){
        ...
        const requestOptions ={
          ...
          fetch('http://54.236.28.178/api/revisioninventariofecha/' + e.target.value, requestOptions)
              .then(response => response.json())
              .then(data => {
                if(data.inv.length === 0){
                    //console.log("No hay")
    ...
    handleIngresarInventario(){
        ...
        if(window.confirm("Seguro desea enviar inventario ??")){
            ...
            fetch('http://54.236.28.178/api/inventarioactual/' + this.state.fechaRegistroInventario, requestOptions)
                .then(response => response.json())
                .then(data => {
                    //console.log(data)
                })
            ...
            fetch('http://54.236.28.178/api/entradasinventario/' + this.state.fechaRegistroInventario, requestOptions)
                .then(response => response.json())
                .then(data => {
                    //console.log(data)
                })
            ...
            fetch('http://54.236.28.178/api/insumocostos/' + this.state.fechaRegistroInventario, requestOptions)
                .then(response => response.json())
                .then(data => {
                    //console.log(data)
                })
