...
class inventarioCaliRefugio extends Component {
    ...
    componentDidMount(){
        ...
        fetch('http://localhost:8081/api/insumos', requestOptions)
        ...
        fetch('http://localhost:8081/api/revisioninventariofecha/' + today, requestOptions)
        .then(response => response.json())
        .then(data => {
    ...
    handleFechaHoy(e){
        ...
        const requestOptions ={
          ...
          fetch('http://localhost:8081/api/revisioninventariofecha/' + e.target.value, requestOptions)
              .then(response => response.json())
              .then(data => {
                if(data.inv.length === 0){
                    //console.log("No hay")
    ...
    handleIngresarInventario(){
        ...
        if(window.confirm("Seguro desea enviar inventario ??")){
            ...
            fetch('http://localhost:8081/api/inventarioactual/' + this.state.fechaRegistroInventario, requestOptions)
                .then(response => response.json())
                .then(data => {
                    //console.log(data)
                })
            ...
            fetch('http://localhost:8081/api/entradasinventario/' + this.state.fechaRegistroInventario, requestOptions)
                .then(response => response.json())
                .then(data => {
                    //console.log(data)
                })
            ...
            fetch('http://localhost:8081/api/insumocostos/' + this.state.fechaRegistroInventario, requestOptions)
                .then(response => response.json())
                .then(data => {
                    //console.log(data)
                })
